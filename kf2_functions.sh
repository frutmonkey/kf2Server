...
function load_config() {
    ...
    dotnet ConfigEdit/ConfigHelper.dll "https://raw.githubusercontent.com/frutmonkey/kf2_MoonFangOfCrispJustice/master/Server.Config" "adminpass" "kf2server/KFGame/Config/"
}
